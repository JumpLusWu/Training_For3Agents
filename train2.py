...
def parse_args():
    ...
    # Environment
    parser.add_argument("--scenario", type=str, default="capt_Wu32", help="name of the scenario script")
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="capt_32_2", help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="./temp_32_2/policy", help="directory in which training state and model should be saved")
    ...
    parser.add_argument("--plots-dir", type=str, default="./learning_curves_32_2",help="where plot data is saved")
