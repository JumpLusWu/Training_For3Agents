...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="capt_33_3", help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="./temp_33_3/policy", help="directory in which training state and model should be saved")
    ...
    parser.add_argument("--plots-dir", type=str, default="./learning_curves_33_3/",help="where plot data is saved")
