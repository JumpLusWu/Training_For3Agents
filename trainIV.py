...
def parse_args():
    ...
    # Environment
    parser.add_argument("--scenario", type=str, default="capt_Wu33", help="name of the scenario script")
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="capt_33_1", help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="./temp_33_1/policy", help="directory in which training state and model should be saved")
    ...
    parser.add_argument("--plots-dir", type=str, default="./learning_curves_33_1/",help="where plot data is saved")
